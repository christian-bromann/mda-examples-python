...
```mermaid
flowchart LR
  Client["Member<br/>portal / cookie session"] --> Proxy["Your API<br/>proxy/server.py"]
...
In production this proxy is any FastAPI/Flask/Django BFF or gateway that already
