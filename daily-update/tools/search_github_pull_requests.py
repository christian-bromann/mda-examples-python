"""Search authored pull requests updated on/after a date."""
...
@tool
def search_github_pull_requests(updated_since: str, limit: int = 50) -> str:
    ...
    query = f"author:@me type:pr updated:>={day}"
    try:
